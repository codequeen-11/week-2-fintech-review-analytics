...
- scripts/ → reusable Python scripts for scraping and preprocessing
...
## Dependencies
The project uses:
- google-play-scraper for collecting app reviews
- pandas for data cleaning and preprocessing
- nltk, transformers, torch, and scikit-learn for sentiment analysis and NLP tasks
